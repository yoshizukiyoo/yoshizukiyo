...
$(function () {
	...
	$('.header').load('/html/smart/' + siteCode + '/_inc-titlebar.html .header > *', function () {
		// if ($.isFunction(window.gnbSetting)) gnbSetting();
	});
	$('.breadcrumb').load('/html/smart/' + siteCode + '/_inc-breadcrumb.html .breadcrumb > *', function () {
		// if ($.isFunction(window.scrollbar)) scrollbar();
	});
	$('.footer').load('/html/smart/' + siteCode + '/_inc-footer.html .footer > *', function () {
