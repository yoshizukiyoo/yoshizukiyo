...
$(function () {
	...
	$('.header').load('/html/' + siteCode + '/' + path[3] + '/' + '/_inc-header.html .header > *', function () {
		// if ($.isFunction(window.gnbSetting)) gnbSetting();
	});
	$('.breadcrumb').load('/html/' + siteCode + '/' + path[3] + '/' + '/_inc-breadcrumb.html .breadcrumb > *', function () {
		// if ($.isFunction(window.scrollbar)) scrollbar();
	});
	$('.footer').load('/html/' + siteCode + '/' + path[3] + '/' + '/_inc-footer.html .footer > *', function () {
